...
public class PushSender implements NotificationSender {
    ...
    public String sendNotification(Notification notification) {
        ...
        if (notification.getRecepientPushToken() == null) {

            queueFailedMessageForRetry(notification);

        } else {

            System.out.println("New Push" + notification.getRecepientPushToken() + " " + notification.getNotificationMessage());
    ...
    public void queueFailedMessageForRetry(Notification notification) {
        ...
        notificationQueueMessage.setNotificationType("Push");
